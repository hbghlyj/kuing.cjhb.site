...
if(!submitcheck('editsubmit')) {
	...
	showsetting('members_edit_avatar', '', '', avatar($uid, 'middle', ['username' => $member['username'], 'avatarstatus' => $member['avatarstatus'], 'random' => 1, 'static' => true]).'<br /><br /><input name="clearavatar" class="checkbox" type="checkbox" value="1" /> '.$lang['members_edit_avatar_clear']);
