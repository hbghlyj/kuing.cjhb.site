...
function checkrobot($useragent = '') {
	static $kw_spiders = ['bot', 'crawl', 'spider', 'slurp', 'sohu-search', 'lycos', 'robozilla', 'algolia crawler', 'baiduspider'];
...
>>>>>>> a0ffb79e9 (remove 'Firefox/7.0' from spider keywords)
}
...
SERVER['HTTP_USER_AGENT'], $kw_spiders, 1)) {
		return $kw;
	}
	if(str_contains(<?php
