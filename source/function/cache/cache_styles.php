...
function build_cache_styles() {
	...
	foreach(table_common_style::t()->fetch_all_data(true) as $data) {
		...
		if(str_contains($data['boardimg'], ',')) {
			$data['boardimg'] = trim(explode(',', $data['boardimg'], 2)[0]);
		}
		...
		$data['boardlogo'] = "<img src=\"{$data['boardimg']}\" alt=\"".i18n::localizeValue($_G['setting']['bbname_i18n'] ?? $_G['setting']['bbname'])."\" class=\"boardlogo\" id=\"boardlogo\" border=\"0\">";
		...
		$data['searchlogo'] = "<img src=\"{$data['searchimg']}\" alt=\"".i18n::localizeValue($_G['setting']['bbname_i18n'] ?? $_G['setting']['bbname'])."\" class=\"searchlogo\" id=\"searchlogo\" border=\"0\">";
		...
		$data['touchlogo'] = "<img src=\"{$data['touchimg']}\" alt=\"".i18n::localizeValue($_G['setting']['bbname_i18n'] ?? $_G['setting']['bbname'])."\" class=\"touchlogo\" id=\"touchlogo\" border=\"0\">";
