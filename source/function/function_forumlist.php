...
function forum(&$forum) {
	...
	if($forum['icon']) {
		...
		$forum['icon'] = '<img src="'.$forum['icon'].'" '.(!empty($forum['extra']['iconwidth']) && !defined('IN_MOBILE') ? 'width="'.$forum['extra']['iconwidth'].'" style="margin-right:'.(40-$forum['extra']['iconwidth']).'px;"' : '').' alt="'.$forum['name'].'" />';
	}
