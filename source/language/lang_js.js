...
//static/js/editor.js
	...
	'current_length'	: '当前长度',
	'bytes'			: '字节',
	'system_limit'		: '系统限制: ',//'System limit: ',
	'up_to'			: ' 到 ',
	'check_length'		: '字数检查',
	'data_restored'		: '数据已恢复',
	'data_saved'		: '数据已保存',
...
//static/js/forum_post.js
	...
	'bad_words'		: '因文件名包含敏感词而无法提交',//'Unable to submit because the file name contains sensitive words',
	'high_resolution'	: '服务器限制无法上传分辨率过高的附件',//'Server restrictions prevent uploading high resolution attachments',
...
//static/js/handlers.js
	...
	'validation_failed'	: '验证失败。 上传已跳过。',//'Failed Validation. Upload skipped.',
	'upload_stopped'	: '停止',//'Stopped',
