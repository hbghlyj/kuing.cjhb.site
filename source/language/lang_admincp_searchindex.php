...
$lang = array (
	...
	array (
		...
		array (
			...
			24 => '允许使用多媒体代码',
			25 => '允许 [audio] [media] 等多媒体代码后，作者将可以在帖子插入多媒体文件并显示',
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	array (
		...
		array (
			...
			23 => '站点 Logo {BOARDIMG},{BOARDLOGO}',
						24 => '可设置 Logo 图片的路径与尺寸，如“logo.png,80,40”',
	...
	array (
		...
		array (
				...
				28 => '允许使用 [audio] [media] 等多媒体代码',
				29 => '设置是否允许 [audio] [media] 等多媒体代码',
				...
				67 => '允许回复草稿',
				68 => '设置是否允许用户回复草稿（回复草稿不增加用户积分，但增加用户发帖数）',
				69 => 'usergroups_edit_post_allowsavenum',
				70 => '允许保存草稿的数量',
				71 => '设置为 0 为不限制用户保存草稿的数量（高流量站点不建议限制草稿数）',
				72 => 'usergroups_edit_post_allowsetpublishdate',
				73 => '允许设置定时发布',
				74 => '允许用户在发布主题时设置指定的发帖时间。只能设置在每半小时（如 13:00 或 13:30）自动发布。',
				75 => 'usergroups_edit_post_allowcommentcollection',
				76 => '允许评论淘专辑',
				77 => '允许用户在主题和淘专辑页面进行评论。',
				79 => '允许主题内容生成图片',
				80 => '看帖时所有帖子正文内容将以字符形式生成图片展示。',
				81 => 'usergroups_edit_attach',
				82 => '附件相关',
				83 => 'usergroups_edit_attach_get',
				84 => '允许下载附件',
				85 => '设置是否允许在没有设置特殊权限的论坛中下载附件',
				86 => 'usergroups_edit_attach_getimage',
				87 => '允许查看图片',
				88 => '设置是否允许在没有设置特殊权限的论坛中查看图片',
				89 => 'usergroups_edit_attach_post',
				90 => '允许上传附件',
				91 => '设置是否允许上传附件到没有设置特殊权限的论坛中。需要 PHP 设置允许才有效，请参考管理中心首页',
				92 => 'usergroups_edit_attach_set_perm',
				93 => '允许设置附件权限',
				94 => '设置是否允许设置附件需要指定积分以上才可下载',
				95 => 'usergroups_edit_image_post',
				96 => '允许上传图片',
				97 => '设置是否允许上传图片到没有设置特殊权限的论坛中。需要 PHP 设置允许才有效，请参考管理中心首页',
				98 => 'usergroups_edit_attach_max_size',
				99 => '论坛最大附件尺寸(单位K 1M=1024K)',
				100 => '设置附件最大尺寸(单位K 1M=1024K)，0 为不限制，需要 PHP 设置允许才有效，请参考管理中心首页',
				101 => 'usergroups_edit_attach_max_size_per_day',
				102 => '每天最大附件总尺寸(单位K 1M=1024K)',
				103 => '设置用户每天可以上传的附件总量(单位K 1M=1024K)，0 为不限制',
				104 => 'usergroups_edit_attach_max_number_per_day',
				105 => '每天最大附件数量',
				106 => '设置用户每天可以上传的附件数量，0 为不限制',
				107 => 'usergroups_edit_attach_ext',
				108 => '允许附件类型',
				109 => '设置允许上传的附件扩展名，多个扩展名之间用半角逗号 "," 隔开，留空为不限制',
