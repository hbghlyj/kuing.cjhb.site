...
class model_forum_post extends discuz_model {
	...
	public function editpost($parameters) {
		...
		$pusher->trigger('Chat', 'editpost', array('tid' => $this->thread['tid'], 'pid' => $this->post['pid'], 'subject' => $isfirstpost && $this->param['subject'] != $this->thread['subject'] ? $this->param['subject'] : ''));
	}
