	...
	private function _init_session() {
		if (empty($_SERVER['HTTP_USER_AGENT']) || strlen($_SERVER['HTTP_USER_AGENT']) < 2) {
			...
			if (isset($_SERVER['HTTP_X_KNOWN_BOT'])) {
				...
				if (!_check_ip_in_cidrs($alibaba_cloud_singapore_cidrs, "Alibaba Cloud Singapore") && !_check_ip_in_cidrs($alibaba_cn_net_cidrs, "Alibaba CN Net") && !_check_ip_in_cidrs($internet_archive_cidrs, "Internet Archive")) {
