		...
		return <<<EOF
{
   tools_image: {
        image: {
            ...
            config: {
                endpoints: {
                    byFile: 'misc.php?mod=upload&operation=jsoneditorupload&type=image&fid='+editor_fid, // Your backend file uploader endpoint
                    byUrl: 'misc.php?mod=upload&operation=jsoneditorupload&type=image&fid='+editor_fid, // Your endpoint that provides uploading by Url
                },
                field: 'Filedata',
                types: 'image/*',
