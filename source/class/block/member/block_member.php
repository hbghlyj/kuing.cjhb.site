	...
	function getdata($style, $parameter) {
		...
		while($data = DB::fetch($query)) {
			...
			$list[] = [
				...
				'fields' => [
					'uid' => $data['uid'],
					'avatar' => avatar($data['uid'], 'small', true, false, $_G['setting']['ucenterurl'], avatarapi: true),
					'avatar_middle' => avatar($data['uid'], 'middle', true, false, $_G['setting']['ucenterurl'], avatarapi: true),
					'avatar_big' => avatar($data['uid'], 'big', true, false, $_G['setting']['ucenterurl'], avatarapi: true),
					'avatarimg' => avatar($data['uid'], 'small', false, false, $_G['setting']['ucenterurl'], avatarapi: true),
					'avatarimg_middle' => avatar($data['uid'], 'middle', false, false, $_G['setting']['ucenterurl'], avatarapi: true),
					'avatarimg_big' => avatar($data['uid'], 'big', false, false, $_G['setting']['ucenterurl'], avatarapi: true),
