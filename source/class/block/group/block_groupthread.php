		...
		while($data = DB::fetch($query)) {
			...
			$list[$data['tid']] = [
				...
				'fields' => [
					...
					'avatar' => avatar(($data['author'] ? $data['authorid'] : 0), 'small', true, false, $_G['setting']['ucenterurl'], avatarapi: true),
					'avatar_middle' => avatar(($data['author'] ? $data['authorid'] : 0), 'middle', true, false, $_G['setting']['ucenterurl'], avatarapi: true),
					'avatar_big' => avatar(($data['author'] ? $data['authorid'] : 0), 'big', true, false, $_G['setting']['ucenterurl'], avatarapi: true),
					'avatarimg' => avatar(($data['author'] ? $data['authorid'] : 0), 'small', false, false, $_G['setting']['ucenterurl'], avatarapi: true),
					'avatarimg_middle' => avatar(($data['author'] ? $data['authorid'] : 0), 'middle', false, false, $_G['setting']['ucenterurl'], avatarapi: true),
					'avatarimg_big' => avatar(($data['author'] ? $data['authorid'] : 0), 'big', false, false, $_G['setting']['ucenterurl'], avatarapi: true),
