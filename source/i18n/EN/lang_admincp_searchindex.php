...
$lang = array (
	...
	array (
		...
		array (
			0 => '数据库 &raquo; 升级',
			1 => 'db_runquery_tips',
			2 => '您可以通过修改 /source/app/admin/child/db/quickquery.php 来添加常用 SQL 操作进行功能扩充。出于安全考虑，Discuz! 后台默认情况下禁止 SQL 语句直接执行，只能使用常用 SQL 当中的内容，如果您想自己随意书写 SQL 升级语句，需要将 config/config_global.php 当中的 $_config[\'admincp\'][\'runquery\'] 设置修改为 1。',
...
',
	...
	array (
		...
		array (
			...
			27 => 'Credit change notification',
			28 => 'Pop up a message to notify the user when their actions change credits',
	...
	array (
		...
		array (
			...
			2 => 'Enable post voting',
			3 => 'Allow users to support or oppose both opening posts and replies.',
			4 => 'setting_functions_threadexp_postreviewdaycount',
			5 => 'Post votes per 24 hours',
			6 => 'Maximum number of posts a user may vote on in 24 hours. Use 0 or leave blank for no limit.',
			7 => 'setting_functions_threadexp_blacklist',
			8 => '启用用户黑名单隐藏',
			9 => '开启后，用户可以通过将其他用户加入黑名单的方法，隐藏指定用户的帖子。',
			10 => 'setting_functions_threadexp_hotreplies',
			11 => '推荐回复数',
			12 => '系统根据回帖评价和水帖情况，在主题第一页推荐回帖，0 为不显示。',
			13 => 'setting_functions_threadexp_filter',
			14 => '水帖字数',
			15 => '系统判断水帖的条件，小于此数值的帖子会被判断为水帖，0 为不过滤水帖。',
			16 => 'setting_functions_threadexp_nofilteredpost',
			17 => '推荐回复时推荐非水帖',
			18 => '启用后会在第一页推荐回复处推荐相应一定的非水帖。',
			19 => 'setting_functions_threadexp_hidefilteredpost',
			20 => '启用隐藏水帖',
			21 => '开启后系统判断为水帖的帖子会被自动隐藏。',
			22 => 'setting_functions_threadexp_filterednovote',
			23 => 'Low-content posts cannot be voted on',
			24 => 'When enabled, posts identified as low-content cannot receive votes.',
		),
	),
	245 => 
	array (
	...
	array (
		...
		array (
			...
			58 => '验证码类型',
			59 => '设置验证码的类型。中文图片验证码需要您的主机支持 FreeType 库验证码预览',
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	array (
		...
		array (
			...
			9 => 'setting_uc_api',
			10 => 'UCenter 访问地址',
			11 => '如果您的头像服务地址发生了改变，请修改此项。不正确的设置可能导致头像与头像裁剪功能异常，请小心修改。格式: http://www.sitename.com/api/avatar (最后不要加\'/\')',
			12 => 'setting_uc_ip',
			13 => 'UCenter IP 地址',
