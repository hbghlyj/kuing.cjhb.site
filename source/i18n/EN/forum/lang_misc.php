...
(
	...
	'perms_allowvisit'		=> 'Visit the forum',//'访问论坛',
	'perms_readaccess'		=> 'Read access',//'阅读权限',
	'perms_allowinvisible'		=> 'Hide online status',//'隐身',
	'perms_allowsearch'		=> 'Use search',//'使用搜索',
	'perms_allowcstatus'		=> 'Custom title',//'自定义头衔',
	'perms_disablepostctrl'		=> 'Post without restrictions',//'发帖不受限制',
	'perms_allowsendpm'		=> 'Send private messages',//'允许发短消息',
	'perms_allowfriend'		=> 'Add friends',//'允许加好友',
	'perms_allowstatdata'		=> 'View statistics reports',//'查看统计数据报表',
	'perms_allowpostarticle'	=> 'Post articles',//'发表文章',
	'perms_allowpost'		=> 'Post new topics',//'发新话题',
	'perms_allowreply'		=> 'Post replies',//'发表回复',
	'perms_allowpostpoll'		=> 'Start polls',//'发起投票',
	'perms_allowvote'		=> 'Vote in polls',//'参与投票',
	'perms_allowpostreward'		=> 'Post rewards',//'发表悬赏',
	'perms_allowpostactivity'	=> 'Post activities',//'发表活动',
	'perms_allowpostdebate'		=> 'Post debates',//'发表辩论',
	'perms_allowposttrade'		=> 'Post trades',//'发表交易',
	'perms_allowat'			=> 'Number of @ mentions',//'允许 @ 的人数',
	'perms_allowreplycredit'	=> 'Set reply rewards',//'允许设置回帖奖励',
	'perms_allowposttag'		=> 'Use tags',//'允许使用标签',
	'perms_allowcreatecollection'	=> 'Number of collections to create',//'允许创建淘专辑的数量',
	...
	'perms_allowgetimage'		=> 'View images',//'查看图片',
	'perms_allowpostattach'		=> 'Upload attachments',//'上传附件',
	'perms_allowpostimage'		=> 'Upload images',//'上传图片',
	'perms_allowsetattachperm'	=> 'Set attachment permissions',//'允许设置附件权限',
	'perms_maxattachsize'		=> 'Max attachment size',//'单个最大附件尺寸',
	'perms_maxsizeperday'		=> 'Max total attachment size per day',//'每天最大附件总尺寸',
	'perms_maxattachnum'		=> 'Max attachments per day',//'每天最大附件数量',
	'perms_attachextensions'	=> 'Allowed attachment types',//'附件类型',
	'perms_allowpoke'		=> 'Send pokes',//'允许打招呼',
	'perms_allowclick'		=> 'React to content',//'允许表态',
	'perms_allowcomment'		=> 'Post comments',//'发表留言/评论',
	'perms_maxspacesize'		=> 'Space size',//'空间大小',
	'perms_maximagesize'		=> 'Max image size',//'单张图片最大尺寸',
	'perms_allowblog'		=> 'Post blogs',//'发表日志',
	'perms_allowupload'		=> 'Upload images',//'上传图片',
	'perms_allowshare'		=> 'Post shares',//'发布分享',
	'perms_allowdoing'		=> 'Post status updates',//'发表记录',
