...
$lang = array (
	...
	'tag_does_not_exist' => 'Tag {tag} does not exist',//'标签 {tag} 不存在',
	'thread_poll_succeed'		=> 'Voted successfully',//'您的投票成功提交，现在将转入主题页。',
	...
	'login_succeed'			=> 'Welcome {usergroup} {username}!<br>Now redirecting to the previous page.',//'欢迎您回来，{username}。现在将转入登录前页面。',
	'login_strike'			=> 'You have tried too many times, please login after 15 minutes',//'密码错误次数过多，请 15 分钟后重新登录',
	'logout_succeed'		=> 'Logged out successfully, now redirecting to the previous page as guest...',//'您已退出站点，现在将以游客身份转入退出前页面……',
	...
	'thread_attention_add_succeed'	=> 'You are now following this thread and will be notified of new replies<br><a href="home.php?mod=space&uid={uid}&do=attention" class="lightlink" target="_blank">[View my followed threads]</a>',//'您已成功关注该主题，有新回复时将通知您',
	'thread_attention_remove_succeed'	=> 'You have stopped following this thread',//'您已取消关注该主题',
	'thread_attention_repeat'	=> 'You are already following this thread',//'抱歉，您已关注该主题，请勿重复关注',
	'thread_attention_does_not_exist'	=> 'You are not following this thread',//'抱歉，您没有关注该主题',
	'thread_attention_delete_succeed'	=> 'Followed threads deleted successfully ',//'关注列表删除成功 ',
	'thread_attention_nonexist'	=> 'Specified thread does not exist',//'抱歉，您指定的主题不存在',
	...
	'follow_cancel_succeed'		=> 'Cancelled successfully',//'取消成功',
	...
	'login_succeed_inactive_member'	=> 'Welcome back {username}!<br>You account needs to be activated, now redirect you to control panel.',//'欢迎您回来，{username}。您的帐号处于非激活状态，现在将转入控制面板。',
	...
	'postreview_yourself_error'	=> 'You cannot vote on your own posts.',
	'postreview_outoftimes'	=> 'Sorry, you have reached the post voting limit for the last 24 hours.',
