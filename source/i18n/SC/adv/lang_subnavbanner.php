...
$lang =
	...
	'subnavbanner_desc' => '展现方式: 页头二级导航栏广告显示于页面上方，通常使用 1200x60 图片形式。当前页面有多个通栏广告时，系统会随机选取其中之一显示。<br />价值分析: 由于能够在页面打开的第一时间将广告内容展现于最醒目的位置，因此成为了网页中价位最高、最适合进行商业宣传或品牌推广的广告类型之一。',
