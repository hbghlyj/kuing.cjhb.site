...
$lang = [
	...
	'emailpost_copy_sent' => '本帖副本已发送到您的已验证邮箱，直接回复该邮件即可回复本帖。',
	'emailpost_copy_failed' => '邮件发送失败，请稍后再试。',
	'emailpost_copy_unavailable' => '邮件副本功能当前不可用。',
	'emailpost_copy_noemail' => '您的账号没有已验证的邮箱，无法使用邮件副本功能。',
	...
	'doing_upload_image_invalid' => '请选择有效的图片。',
	'doing_upload_image_ext_invalid' => '记录图片仅支持 JPG、PNG、GIF、WebP 或 BMP。',
	'doing_upload_image_too_large' => '单张图片不能超过 {size} KB。',
	'doing_upload_image_too_many' => '每条记录最多上传 {num} 张图片。',
	'doing_upload_video_invalid' => '请选择有效的视频。',
	'doing_upload_video_disabled' => '记录视频上传功能已关闭。',
	'doing_upload_video_ext_invalid' => '记录视频仅支持以下格式：{ext}。',
	'doing_upload_video_too_large' => '单个视频不能超过 {size} MB。',
	...
	'attention_status_off' => '抱歉，关注功能尚未开启',
	...
	'register_check_found' => '该用户名已被占用，<a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href);return false;">登录</a>',
	...
	'postcomment_too_long' => '点评最多 200 个字符，请改用回复发布更长内容',
	...
	'thread_attention_add_succeed' => '您已成功关注该主题，有新回复时将通知您<br><a href="home.php?mod=space&uid={uid}&do=attention" class="lightlink" target="_blank">[查看我关注的主题]</a>',
	'thread_attention_remove_succeed' => '您已取消关注该主题',
	'thread_attention_repeat' => '抱歉，您已关注该主题，请勿重复关注',
	'thread_attention_does_not_exist' => '抱歉，您没有关注该主题',
	'thread_attention_delete_succeed' => '关注列表删除成功 ',
	'thread_attention_nonexist' => '抱歉，您指定的主题不存在',
	'thread_attention_self' => '您不能关注自己发表的主题',
	...
	'admin_getip_nopermission' => '抱歉，您无权查看更高权限管理员的 IP 地址',
	'admin_getip_noip' => '该用户没有留下 IP 地址记录',
