...
$lang = [
	...
	'filecheck_git_unavailable' => 'Git 不可用，无法执行文件校验。',
	...
	'tag_merge_nonexistence' => '目标标签不存在，请先创建后再合并。',
	'tag_rename_invalid' => '标签名称须为 2 至 35 个字符，且不能包含逗号',
	...
	'members_pm_delete_succeed' => '已删除 {number} 个私信会话。',
