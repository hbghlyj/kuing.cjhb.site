...
$lang =
	...
	'intercat_desc' => '展現方式: 論壇分類間廣告顯示於版塊列表相鄰的兩個版塊分類之間，可使用 1200x60 或其他尺寸圖片形式。當前頁面有多個分類間廣告時，系統會從中抽取與版塊分類數相等的條目進行隨機顯示。<br />價值分析:由於出現在版塊列表頁比較明顯的位置，廣告展示效果較好，但是過多過大的廣告可能會招致訪問者反感。 ',
	'intercat_fids' => '投放分區',
