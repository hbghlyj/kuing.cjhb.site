...
$lang =
	...
	'groupattachment_gtids_comment' => '設定圈子所在分類，可以按住 CTRL 多選，全選或全不選均爲不做限制',
	'groupattachment_startrow' => '起始數據行數',
	'groupattachment_startrow_comment' => '如需設定起始的數據行數，請輸入具體數值，0 爲從第一行開始，以此類推',
	'groupattachment_items' => '顯示數據條數',
	'groupattachment_items_comment' => '設定一次顯示的圖片主題條目數，請設定爲大於 0 的整數',
	...
	'groupattachment_maxwidth_comment' => '設定是否自動縮小或放大圖片的尺寸到本設定的寬度，0 爲不自動縮放',
	'groupattachment_maxheight' => '圖片最大高度(像素)',
	'groupattachment_maxheight_comment' => '設定是否自動縮小或放大圖片的尺寸到本設定的高度，0 爲不自動縮放',
	...
	'groupattachment_digest_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	...
	'groupattachment_special_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
