...
$lang =
	...
	'groupactivity_gtids_comment' => '設定圈子所在分類，可以按住 CTRL 多選，全選或全不選均爲不做限制',
	'groupactivity_uids' => '發起者UID',
	'groupactivity_uids_comment' => '設定活動發起人UID ，多個 UID 請用半角逗號“,”隔開。',
	'groupactivity_startrow' => '起始數據行數',
	'groupactivity_startrow_comment' => '如需設定起始的數據行數，請輸入具體數值，0 爲從第一行開始，以此類推',
	'groupactivity_items' => '顯示數據條數',
	'groupactivity_items_comment' => '設定一次顯示的主題條目數，請設定爲大於 0 的整數',
	'groupactivity_titlelength' => '標題最大字節數',
	'groupactivity_titlelength_comment' => '設定當標題長度超過本設定時，是否將標題自動縮減到本設定中的字節數，0 爲不自動縮減',
	...
	'groupactivity_summarylength_comment' => '設定主題簡短內容的文字數，0 爲使用預設值 255',
	'groupactivity_tids' => '指定主題',
	'groupactivity_tids_comment' => '設定要指定顯示的主題 tid ，多個 tid 請用半角逗號“,”隔開。注意: 留空爲不進行任何過濾',
	'groupactivity_keyword' => '標題關鍵字',
	'groupactivity_keyword_comment' => '設定標題包含的關鍵字。注意: 留空爲不進行任何過濾； 關鍵字中可使用通配符 *； 匹配多個關鍵字全部，可用空格或 AND 連接。如 win32 AND unix； 匹配多個關鍵字其中部分，可用 | 或 OR 連接。如 win32 OR unix',
	'groupactivity_typeids' => '主題分類',
	'groupactivity_typeids_comment' => '設定特定分類的主題。注意: 全選或全不選均爲不進行任何過濾',
	'groupactivity_typeids_all' => '全部的主題分類',
	'groupactivity_sortids' => '分類資訊',
	'groupactivity_sortids_comment' => '設定特定分類資訊的主題。注意: 全選或全不選均爲不進行任何過濾',
	'groupactivity_sortids_all' => '全部的分類資訊',
	'groupactivity_digest' => '精華主題過濾',
	'groupactivity_digest_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	...
	'groupactivity_stick_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	...
	'groupactivity_special_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
