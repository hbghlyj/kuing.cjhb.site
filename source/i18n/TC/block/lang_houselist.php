...
$lang =
	...
	'categorylist_fids_comment' => '設定允許參與新帖調用的版塊，可以按住 CTRL 多選，全選或全不選均爲不做限制',
	'categorylist_startrow' => '起始數據行數',
	'categorylist_startrow_comment' => '如需設定起始的數據行數，請輸入具體數值，0 爲從第一行開始，以此類推',
	'categorylist_showitems' => '顯示數據條數',
	'categorylist_showitems_comment' => '設定一次顯示的主題條目數，請設定爲大於 0 的整數',
	'categorylist_titlelength' => '標題最大字節數',
	'categorylist_titlelength_comment' => '設定當標題長度超過本設定時，是否將標題自動縮減到本設定中的字節數，0 爲不自動縮減',
	...
	'categorylist_summarylength_comment' => '設定主題簡短內容的文字數，0 爲使用預設值 255',
	'categorylist_tids' => '指定主題',
	'categorylist_tids_comment' => '設定要指定顯示的主題 tid ，多個 tid 請用半角逗號“,”隔開。注意: 留空爲不進行任何過濾',
	'categorylist_keyword' => '標題關鍵字',
	'categorylist_keyword_comment' => '設定標題包含的關鍵字。注意: 留空爲不進行任何過濾； 關鍵字中可使用通配符 *； 匹配多個關鍵字全部，可用空格或 AND 連接。如 win32 AND unix； 匹配多個關鍵字其中部分，可用 | 或 OR 連接。如 win32 OR unix',
	'categorylist_sortids' => '分類資訊',
	'categorylist_sortids_comment' => '設定特定分類的主題。注意: 全選或全不選均爲不進行任何過濾',
	'categorylist_styleids' => '分類模板',
	'categorylist_styleids_comment' => '在後臺對應的分類資訊裡面設定模板',
	...
	'categorylist_categoryids_comment' => '設定特定分類資訊的主題。注意: 全選或全不選均爲不進行任何過濾',
	'categorylist_categoryids_all' => '全部的分類資訊',
	'categorylist_digest' => '精華主題過濾',
	'categorylist_digest_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	...
	'categorylist_stick_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	...
	'categorylist_special_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
