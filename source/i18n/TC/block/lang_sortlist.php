...
$lang =
	[
	'sortlist_fids' => '所在版塊',
	'sortlist_fids_comment' => '設定允許參與新帖調用的版塊，可以按住 CTRL 多選，全選或全不選均爲不做限制',
	'sortlist_startrow' => '起始數據行數',
	'sortlist_startrow_comment' => '如需設定起始的數據行數，請輸入具體數值，0 爲從第一行開始，以此類推',
	'sortlist_showitems' => '顯示數據條數',
	'sortlist_showitems_comment' => '設定一次顯示的主題條目數，請設定爲大於 0 的整數',
	'sortlist_titlelength' => '標題最大字節數',
	'sortlist_titlelength_comment' => '設定當標題長度超過本設定時，是否將標題自動縮減到本設定中的字節數，0 爲不自動縮減',
	'sortlist_fnamelength' => '標題最大字節數包含版塊名稱',
	'sortlist_fnamelength_comment' => '設定標題長度是否將所在版塊名稱的長度一同計算在內',
	'sortlist_summarylength' => '主題簡短內容文字數',
	'sortlist_summarylength_comment' => '設定主題簡短內容的文字數，0 爲使用預設值 255',
	'sortlist_tids' => '指定主題',
	'sortlist_tids_comment' => '設定要指定顯示的主題 tid ，多個 tid 請用半角逗號“,”隔開。注意: 留空爲不進行任何過濾',
	'sortlist_keyword' => '標題關鍵字',
	'sortlist_keyword_comment' => '設定標題包含的關鍵字。注意: 留空爲不進行任何過濾； 關鍵字中可使用通配符 *； 匹配多個關鍵字全部，可用空格或 AND 連接。如 win32 AND unix； 匹配多個關鍵字其中部分，可用 | 或 OR 連接。如 win32 OR unix',
	'sortlist_typeids' => '主題分類',
	'sortlist_typeids_comment' => '設定特定分類的主題。注意: 全選或全不選均爲不進行任何過濾',
	'sortlist_typeids_all' => '全部的主題分類',
	'sortlist_sortids' => '分類資訊',
	'sortlist_sortids_comment' => '設定特定分類資訊的主題。注意: 全選或全不選均爲不進行任何過濾',
	'sortlist_sortids_all' => '全部的分類資訊',
	'sortlist_digest' => '精華主題過濾',
	'sortlist_digest_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	'sortlist_digest_0' => '普通主題',
	'sortlist_digest_1' => '精華 I',
	'sortlist_digest_2' => '精華 II',
	'sortlist_digest_3' => '精華 III',
	'sortlist_stick' => '置頂主題過濾',
	'sortlist_stick_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	'sortlist_stick_0' => '普通主題',
	'sortlist_stick_1' => '置頂 I',
	'sortlist_stick_2' => '置頂 II',
	'sortlist_stick_3' => '置頂 III',
	'sortlist_special' => '特殊主題過濾',
	'sortlist_special_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
