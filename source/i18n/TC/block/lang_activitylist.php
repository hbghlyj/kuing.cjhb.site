...
$lang =
	...
	'activitylist_fids_comment' => '設定允許參與新帖調用的版塊，可以按住 CTRL 多選，全選或全不選均爲不做限制',
	'activitylist_uids' => '發起者UID',
	'activitylist_uids_comment' => '設定活動發起者UID，多個UID請用半角逗號“,”隔開。',
	'activitylist_startrow' => '起始數據行數',
	'activitylist_startrow_comment' => '如需設定起始的數據行數，請輸入具體數值，0 爲從第一行開始，以此類推',
	'activitylist_items' => '顯示數據條數',
	'activitylist_items_comment' => '設定一次顯示的主題條目數，請設定爲大於 0 的整數',
	'activitylist_titlelength' => '標題最大字節數',
	'activitylist_titlelength_comment' => '設定當標題長度超過本設定時，是否將標題自動縮減到本設定中的字節數，0 爲不自動縮減',
	...
	'activitylist_summarylength_comment' => '設定主題簡短內容的文字數，0 爲使用預設值 255',
	'activitylist_tids' => '指定主題',
	'activitylist_tids_comment' => '設定要指定顯示的主題 tid ，多個 tid 請用半角逗號“,”隔開。注意: 留空爲不進行任何過濾',
	'activitylist_keyword' => '標題關鍵字',
	'activitylist_keyword_comment' => '設定標題包含的關鍵字。注意: 留空爲不進行任何過濾； 關鍵字中可使用通配符 *； 匹配多個關鍵字全部，可用空格或 AND 連接。如 win32 AND unix； 匹配多個關鍵字其中部分，可用 | 或 OR 連接。如 win32 OR unix',
	'activitylist_typeids' => '主題分類',
	'activitylist_typeids_comment' => '設定特定分類的主題。注意: 全選或全不選均爲不進行任何過濾',
	'activitylist_typeids_all' => '全部的主題分類',
	'activitylist_sortids' => '分類資訊',
	'activitylist_sortids_comment' => '設定特定分類資訊的主題。注意: 全選或全不選均爲不進行任何過濾',
	'activitylist_sortids_all' => '全部的分類資訊',
	'activitylist_digest' => '精華主題過濾',
	'activitylist_digest_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	...
	'activitylist_stick_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
	...
	'activitylist_special_comment' => '設定特定的主題範圍。注意: 全選或全不選均爲不進行任何過濾',
