...
$result = DB::fetch_all('SELECT a.tid,a.maxposition,a.lastpost,a.fid IN (2,9,10) as excl FROM ' . DB::table("forum_thread") . ' a ORDER BY a.lastpost DESC '.DB::limit(0, 20000));
