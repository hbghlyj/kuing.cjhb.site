...
<div class="tip loginbox loginpop p5" id="floatlayout_topicadmin">
	<form id="postdeleteform" method="post" autocomplete="off" action="forum.php?mod=misc&action=postdelete&tid=$post[tid]&pid=$_GET[pid]&extra=$extra{if !empty($_GET[page])}&page=$_GET[page]{/if}&postdeletesubmit=yes&infloat=yes" >
