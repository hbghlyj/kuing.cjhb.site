...
<div class="header_toplogo"><img src="{$_G['style']['touchimg']}" alt="{$_G['setting']['bbname']}" class="touchlogo" id="touchlogo" border="0"><p><!--{if !isset($_GET['viewlostpw'])}-->{lang login}<!--{else}-->{lang getpassword}<!--{/if}--></p></div>
<!--{/if}-->
