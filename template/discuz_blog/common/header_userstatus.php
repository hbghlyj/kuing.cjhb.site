...
<div class="header-right">
	...
	<div class="header-notice">
		<div class="notice-icon"><a href="home.php?mod=spacecp&ac=plugin&id=myrepeats:memcp" id="myrepeats" class="kmico" onmouseover="delayShow(this, showmyrepeats)" title="{lang blog_avatar_settings}">
		...
		<div class="header-user-dropdown poptip-popper">
			...
			<div class="user-card">
				...
				<div class="user-card-area">
					...
					<a href="javascript:saveUserdata('diy_advance_mode', '1');openDiy();">{lang blog_diy_settings}</a>
					<!--{/if}-->
