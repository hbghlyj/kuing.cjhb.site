...
<html lang="{echo lang_attr();}">
	...
	<!--{hook/global_meta}-->
	<!--{if !IS_ROBOT}--><!--{subtemplate common/header_mathjax}--><!--{/if}-->
	<!--{csstemplate}-->
	...
	.dz_btm_layer .header-searcher .ais-SearchBox-input{width: 200px;}
	<!--{/if}-->
	...
	<link rel="stylesheet" type="text/css" href="{STYLEIMGDIR}/css/shiguang.css?{VERHASH}" />
