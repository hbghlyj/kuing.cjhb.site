		...
		<div class="mn">
			<div class="bm bml pbn sg-forum-page-heading">
				...
				<!--{if (!empty($_G[forum][domain]) && !empty($_G['setting']['domain']['root']['forum'])) || $moderatedby || ($_G['page'] == 1 && $_G['forum']['rules'])}-->
					<div class="bm_c pbn sg-forum-page-heading__meta">
						<!--{if !empty($_G[forum][domain]) && !empty($_G['setting']['domain']['root']['forum'])}-->
							<div class="pbn sg-forum-page-heading__extra">{lang forum_domain}: <a href="{$_G['scheme']}://{$_G[forum][domain]}.{$_G['setting']['domain']['root']['forum']}" id="group_link">{$_G['scheme']}://{$_G[forum][domain]}.{$_G['setting']['domain']['root']['forum']}</a></div>
						<!--{/if}-->
						<!--{if $moderatedby}--><div class="sg-forum-page-heading__extra">{lang forum_modedby}: <span class="xi2">$moderatedby</span></div><!--{/if}-->
						<!--{if $_G['page'] == 1 && $_G['forum']['rules']}-->
							<div id="forum_rules_{$_G[fid]}" class="sg-forum-rules-panel" style="{if $_G['style']['blog_mod']}display:none;{else}$collapse['forum_rules'];{/if}">
			...
			<!--{if $subexists && $_G['page'] == 1 && !$_G['style']['blog_mod']}--><!--{template forum/forumdisplay_subforum}--><!--{/if}-->
...
<!--{/if}-->
<div class="wp mtn sg-forumdisplay-bottom-diy">
