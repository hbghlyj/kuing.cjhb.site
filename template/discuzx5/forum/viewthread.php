	...
	<table class="posthead cp0">
		<tr>
			...
			<td class="plc vwthd">
				<!--{if !IS_ROBOT}-->
					<div class="y">
						<a href="forum.php?mod=viewthread&tid=$_G[tid]$fromuid" onclick="return copyThreadUrl(this, '$_G[setting][bbname]')" title="{lang share_url_copy}"><i class="fico-link fic4 fc-s vm"></i></a>
