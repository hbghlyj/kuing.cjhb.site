	...
	<!--{if empty($gid)}-->
		<div id="chart" class="bm bw0 cl">
			...
			<div class="y">
				...
				<!--{if !$_G['style']['is_fixtop'] && isset($_G['cookie']['viewid'])}--><a href="forum.php?mod=redirect&tid={echo substr($_G['cookie']['viewid'],4)}&goto=lastpost#newpost" target="_blank" class="xi2">{lang lastvisit}</a><span class="pipe">|</span><!--{/if}-->
