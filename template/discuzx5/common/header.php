	...
	<!--{if empty($topic) || $topic['useheader']}-->
		...
		<div class="wp">
			<!--{if !empty($_G['cookie']['recentthreads'])}-->
				...
				<!--{if $recentthreadlist}-->
				<span class="pg y"><a href="javascript:;" id="recentthreads" onmouseover="showMenu({'ctrlid':this.id,'pos':'34'})">{lang viewed_threads}</a></span>
			...
			<!--{if $_G['setting']['visitedforums']}-->
				...
				<span class="pg y"><a href="javascript:;" id="visitedforums" onmouseover="showMenu({'ctrlid':this.id,'pos':'34'})">{lang viewed_forums}</a></span>
