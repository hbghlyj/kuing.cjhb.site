...
<html lang="{echo lang_attr();}">
	...
	@font-face {
	  ...
	  src: url('https://mirrors.ctan.org/fonts/tex-gyre/opentype/texgyrepagella-regular.otf') format('opentype');
	  font-weight: 400;
	  font-style: normal;
	  font-display: swap;
	}
	@font-face {
	  font-family: 'TeX Gyre Pagella';
	  src: url('https://mirrors.ctan.org/fonts/tex-gyre/opentype/texgyrepagella-italic.otf') format('opentype');
	  font-weight: 400;
	  font-style: italic;
	  font-display: swap;
	}
	@font-face {
	  font-family: 'TeX Gyre Pagella';
	  src: url('https://mirrors.ctan.org/fonts/tex-gyre/opentype/texgyrepagella-bold.otf') format('opentype');
	  font-weight: 700;
	  font-style: normal;
	  font-display: swap;
	}
	@font-face {
	  font-family: 'TeX Gyre Pagella';
	  src: url('https://mirrors.ctan.org/fonts/tex-gyre/opentype/texgyrepagella-bolditalic.otf') format('opentype');
	  font-weight: 700;
	  font-style: italic;
	  font-display: swap;
	}
