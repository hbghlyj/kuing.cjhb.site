...
DROP TABLE IF EXISTS pre_common_pm_thread;
CREATE TABLE pre_common_pm_thread
(
	...
	KEY lastdateline (lastdateline)
) ENGINE = InnoDB;

DROP TABLE IF EXISTS pre_common_pm_member;
CREATE TABLE pre_common_pm_member
(
	...
	KEY uid_new (uid, isnew),
	KEY uid_lastdateline (uid, lastdateline)
) ENGINE = InnoDB;

DROP TABLE IF EXISTS pre_common_pm_message;
CREATE TABLE pre_common_pm_message
(
	...
	dateline int(10) unsigned      NOT NULL DEFAULT '0',
	PRIMARY KEY (pmid),
	KEY plid_dateline (plid, dateline),
	KEY authorid (authorid)
) ENGINE = InnoDB;

DROP TABLE IF EXISTS pre_common_pm_message_status;
CREATE TABLE pre_common_pm_message_status
(
...
DROP TABLE IF EXISTS pre_common_pm_blacklist;
CREATE TABLE pre_common_pm_blacklist
(
	uid       mediumint(8) unsigned NOT NULL DEFAULT '0',
