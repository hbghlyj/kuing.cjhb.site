(function() {
	...
	oceanSvg.innerHTML = '<defs>' +
		...
		'<filter id="sway" x="-8%" y="-10%" width="116%" height="120%"><feTurbulence type="fractalNoise" baseFrequency=".003 .018" numOctaves="1" seed="' + (seed + 17) + '" stitchTiles="stitch" result="n"/><feDisplacementMap in="SourceGraphic" in2="n" scale="15" xChannelSelector="R" yChannelSelector="G"/></filter>' +
		'<filter id="swell" x="-4%" y="-4%" width="108%" height="108%"><feTurbulence type="fractalNoise" baseFrequency=".0025 .009" numOctaves="2" seed="' + (seed + 23) + '" stitchTiles="stitch" result="n"/><feGaussianBlur in="n" stdDeviation="2" result="b"/><feDiffuseLighting in="b" surfaceScale="3" diffuseConstant=".9" lighting-color="#fff" result="l"><feDistantLight azimuth="300" elevation="55"/></feDiffuseLighting><feComposite in="l" in2="SourceAlpha" operator="in"/></filter>' +
		'<filter id="ripFar" x="-4%" y="-4%" width="108%" height="108%"><feTurbulence type="fractalNoise" baseFrequency=".014 .12" numOctaves="2" seed="' + (seed + 31) + '" stitchTiles="stitch" result="n"/><feGaussianBlur in="n" stdDeviation=".35" result="b"/><feDiffuseLighting in="b" surfaceScale="1.3" diffuseConstant=".85" lighting-color="#f4faff"><feDistantLight azimuth="300" elevation="60"/></feDiffuseLighting><feComposite in2="SourceAlpha" operator="in"/></filter>' +
		'<filter id="ripNear" x="-4%" y="-4%" width="108%" height="108%"><feTurbulence type="fractalNoise" baseFrequency=".009 .06" numOctaves="2" seed="' + (seed + 33) + '" stitchTiles="stitch" result="n"/><feGaussianBlur in="n" stdDeviation=".5" result="b"/><feDiffuseLighting in="b" surfaceScale="2.4" diffuseConstant=".95" lighting-color="#f4faff"><feDistantLight azimuth="300" elevation="55"/></feDiffuseLighting><feComposite in2="SourceAlpha" operator="in"/></filter>' +
		'<filter id="specFar" x="-4%" y="-5%" width="108%" height="112%"><feTurbulence type="fractalNoise" baseFrequency=".010 .09" numOctaves="2" seed="' + (seed + 42) + '" stitchTiles="stitch" result="n"/><feGaussianBlur in="n" stdDeviation=".5" result="b"/><feSpecularLighting in="b" surfaceScale="1.6" specularConstant="1.15" specularExponent="16" lighting-color="#f0f8ff"><feDistantLight azimuth="300" elevation="58"/></feSpecularLighting><feComposite in2="SourceAlpha" operator="in"/></filter>' +
		'<filter id="specNear" x="-4%" y="-5%" width="108%" height="112%"><feTurbulence type="fractalNoise" baseFrequency=".006 .05" numOctaves="2" seed="' + (seed + 77) + '" stitchTiles="stitch" result="n"/><feGaussianBlur in="n" stdDeviation=".7" result="b"/><feSpecularLighting in="b" surfaceScale="2.6" specularConstant="1.05" specularExponent="13" lighting-color="#f2f9ff"><feDistantLight azimuth="300" elevation="52"/></feSpecularLighting><feComposite in2="SourceAlpha" operator="in"/></filter>' +
